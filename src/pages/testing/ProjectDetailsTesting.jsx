            ...
            <div className="bg-white rounded-xl shadow-lg sticky top-24">
              <div className="p-8">
                ...
                <Link to={`/chat/${project.id}/${project.builder_id}`}>
                  <button className="w-full px-6 py-3 bg-amber-950 text-white font-semibold rounded-lg hover:bg-primary-700 transition-colors flex items-center justify-center gap-2">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
